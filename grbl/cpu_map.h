...
#define cpu_map_h
  ...
  #define Y_STEP_BIT      2  // Uno Digital Pin 2
  ...
  #define X_DIRECTION_BIT   6  // Uno Digital Pin 6
  ...
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    #define SPINDLE_TCCRB_INIT_MASK      ((1<<CS22) | (1<<CS21) | (1<<CS20)) // 1/1024 prescaler -> 61Hz, best for servo motors
